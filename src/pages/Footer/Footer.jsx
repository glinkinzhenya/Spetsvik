    ...
    <footer id="contacts" className='footer container'>
      ...
      <div className='footer-secondary'>
        ...
        <div className='footer-secondary__telephone'>
          ...
          <CallBack buttonText="Ми Вам зателефонуємо" dialogTitle="Введіть Ваш номер телефону та коментар" dialogText="Ми зателефонуємо як найшвідше та відповемо на всі ваші питання" confirmText="Надіслати" cancelText="Відміна" fontSize="12px" />
